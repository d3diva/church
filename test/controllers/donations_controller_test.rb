...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference("Donation.count") do
      post donations_url, params: { donation: { amount: @donation.amount, description: @donation.description, donate_date: @donation.donate_date } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { amount: @donation.amount, description: @donation.description, donate_date: @donation.donate_date } }
